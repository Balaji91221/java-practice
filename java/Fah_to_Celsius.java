...
public class Fah_to_Celsius {
    public static void main(String[] args) {
        ...
        int currentFah = start;
        while(currentFah <= end){
            int celsius = (int)((5.0/9)*(currentFah - 32)); // temmp = (5/9)*(temp - 32)
            System.out.println(currentFah + "\t" + celsius); // \t is used to print a tab space
            currentFah = currentFah + step;// currentFah += step;
        }
